...
@Component
public class UpdateStdFrame extends JFrame {
	...
	public UpdateStdFrame(MyService myService2, Student student) {
		...
		textFieldSid = new JTextField(student.getSid());
		...
		textFieldSname = new JTextField(student.getSname());
		...
		textFieldMajor = new JTextField(student.getMajor());
		...
		int idx=Integer.parseInt(student.getYear())-1;
...
//				student = new Student();
				if(textFieldSid.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null, "แก้ไขข้อมูลสำเร็จเรียบร้อย");
					}else {
